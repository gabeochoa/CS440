...
template <typename T>
void deleteTest() {
  std::cout << "All erase tests will use the same set of 10000 elements to find and erase" << std::endl;
  ...
  
  {
    ...
    while(toDelete.size() < 10000) {
      toDelete.push_back(distribution(generator));
    }
  }
...
template <typename T>
void findTest() {
  std::cout << "All find tests will use the same set of 10000 elements to find and erase" << std::endl;
