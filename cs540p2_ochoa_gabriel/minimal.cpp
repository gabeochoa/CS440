...
class MyKeyType {
    ...
    public:
        ...
        friend inline std::ostream& operator<<(std::ostream& o, const MyKeyType& p) 
        {
            o << p.val;
            return o;
        }
...
class MyValueType {
    ...
    public:
        ...
        friend inline std::ostream& operator<<(std::ostream& o, const MyValueType& p) 
        {
            o << p.val;
            return o;
        }
...
class MyDefaultConstructible {
    ...
    public:
        ...
        friend inline std::ostream& operator<<(std::ostream& o, const MyDefaultConstructible& p) 
        {
            o << p.val;
            return o;
        }
...
class MyAssignable {
    ...
    public:
        ...
        friend inline std::ostream& operator<<(std::ostream& o, const MyAssignable& p) 
        {
            o << p.val;
            return o;
        }
