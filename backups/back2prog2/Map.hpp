        ...
        public:
            ...
            Mapped_T& operator[](const Key_T & kee)
            {
                try{
                    ...
                    std::cout << "Found: " << v.first << " " << v.second << std::endl;
                    return v.second;
                }catch(const std::out_of_range& e)
                {
                    std::cout << "Making: " << kee << std::endl;
                    return insert(make_pair(kee, Mapped_T())).first->second;
                }
            } 
            ...
            insert(std::initializer_list<Key_T> const& lis)
            {
                ...
                std::pair<IT, bool> ret = std::make_pair(begin(), false);
                return ret;
            }
