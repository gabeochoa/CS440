...
#include <string.h>
    ...
    {                                                                                 \
        ...
        int i = d->d_front;                                                           \
        d->d_alloc *= 2;                                                              \
        int *temp = ( int *) malloc(sizeof( int )*d->d_alloc);                        \
        int cur = i;                                                                  \
        int stop = d->d_back + d->d_size - d->d_front;                                \
        while(true)                                                                   \
        {                                                                             \
            std::cout << "COPY: " << d->d_data[cur%d->d_alloc+1] << " to " << 1 << std::endl; \
            temp[i] = d->d_data[cur%d->d_alloc+1];                                    \
            if(cur >= stop)                                                           \
                break;                                                                \
            cur++;                                                                    \
            i++;                                                                      \
    ...
    {                                                                                 \
     ...
     {                                                                                \
        ...
        if(((d->d_front-1)%d->d_alloc) == d->d_back)                                  \
        {                                                                             \
            alloCopy(d);                                                              \
